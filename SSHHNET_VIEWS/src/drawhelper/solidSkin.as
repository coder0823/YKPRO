...
{   
	...
	{   
		private var colors:Array = views.CustomColor.CColor;//[0x60cb00,0x6a7a88,0x3698ff,0x66a800,0xff6600,0x655fc8,0xd2691e];   
		...
		//根据长宽获取3D坐标信息   
		private function getPoints(w:Number,h:Number):Array   
		{   
		...
		private function drawFill(...args):void   
		{   
			with(this.graphics)   
			{   
