package views
{
	...
	* */
	...
	import skins.popWinStyle_noExport;
	
	import spark.components.Group;
	import spark.components.TitleWindow;
	
	public class PopupTitleWin_noExport extends TitleWindow
	{
		...
		public function PopupTitleWin_noExport()
		{
			super();
			init();
		}
		private function init():void{
			...
			this.setStyle("skinClass",skins.popWinStyle_noExport);
			this.minWidth=900;
			this.minHeight=500;
